  ...
  var Sidenav = function (_Component8) {
    ...
    _createClass(Sidenav, [{
      ...
      value: function _setupEventHandlers() {
        ...
        this.dragTarget.addEventListener('touchmove', _setupEventHandlers, {passive: true}, {capture: true}, this._handleDragTargetDragBound);
        this.dragTarget.addEventListener('touchend', this._handleDragTargetReleaseBound);
        this._overlay.addEventListener('touchmove',_setupEventHandlers, {passive: true}, {capture: true}, this._handleCloseDragBound);
        this._overlay.addEventListener('touchend', this._handleCloseReleaseBound);
        this.el.addEventListener('touchmove',_setupEventHandlers, {passive: true}, {capture: true}, this._handleCloseDragBound);
